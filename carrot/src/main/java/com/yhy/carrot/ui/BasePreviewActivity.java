...
import com.yhy.carrot.etc.utils.PlatformUtils;
import com.yhy.carrot.listener.OnFragmentInteractionListener;
import com.yhy.carrot.model.SelectedItemCollection;
import com.yhy.carrot.ui.adapter.PreviewPagerAdapter;
import com.yhy.carrot.ui.widget.CheckRadioView;
import com.yhy.carrot.ui.widget.CheckView;
...
public abstract class BasePreviewActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    protected void updateSize(Item item) {
        if (item.isGif()) {
            ...
            mSize.setText(PhotoUtils.getSizeInMB(item.size) + "M");
        } else {
